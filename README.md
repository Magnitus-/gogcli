...
# Other Supported Cookie Formats
...
A cookie string with values separated by semicolons.

Can be obtained from Chrome by doing:
- Left click + **Inspect**
- Click on **Network**
- Go to your library page and download a small file
- Click on the request that returned a 302 and select **Headers**
- Under **Request Headers**, copy the entire content of the **Cookie:** header (on the right side) to a file

## Firefox Cookies

A Json cookie value generated by firefox.

Can be obtained from Firefox by doing:
- Left click + **Inspect**
- Click on **Network**
- Go to your library page and download a small file
- Click on the request that returned a 302 and select **Cookies**
- Under **Request Cookies**, left-click on the first value and select **Copy All**
- Paste in a file

If you did it correctly, it should be a json document with the root key having a value of **Request Cookies**.
