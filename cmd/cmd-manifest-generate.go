...
func generateManifestGenerateCmd() *cobra.Command {
	...
	manifestGenerateCmd.Flags().StringArrayVarP(&hasUrlFilters, "has-url", "j", []string{}, "Regex of file urls that should match at least one of the game's installer files")
